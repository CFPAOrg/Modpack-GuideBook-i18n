...
function addInfo(stack as IItemStack) as IItemStack {
    return stack.withDisplayName(game.localize(ofsf~"misc.hf"))
        .withLore([
            game.localize(ofsf~"misc.hf.lore1"),
            game.localize(ofsf~"misc.hf.lore2"),
            game.localize(ofsf~"misc.hf.lore3")
        ]);
}
