onEvent('jei.information', (event) => {
    const recipes = [
        ...
        },
        {
            ...
            text: [
                '可以在末地的寒冰星空生物群系中找到，也可以在远古翡翠冰旁放置水制造。'
            ]
        },
        {
            items: ['betterendforge:dense_emerald_ice'],
            text: [
                '可以在末地的寒冰星空生物群系中找到，也可以在远古翡翠冰旁放置翡翠冰制造。'
            ]
        },
        {
            items: ['betterendforge:ancient_emerald_ice'],
            text: [
                '可以在末地的寒冰星空生物群系中找到，可以把相邻的水方块变成翡翠冰，把翡翠冰变成致密翡翠冰。'
            ]
        },
        {
        ...
        },
        {
            ...
            text: [
                `击败诡异蚊鬼后获得。`,
                ` `,
                `诡异蚊鬼是一种由绯红蚊子突变形成的怪物。玩家需要前往蘑菇岛找到一个没有蘑菇的蘑菇君，然后用诡异菌插满它的身体（5个即可），让绯红蚊子吸它的血，然后绯红蚊子会变成蓝色并慢慢变大，最后突变成诡异蚊鬼。`
            ]
        },
        {
            items: ['alexsmobs:hemolymph_sac', 'alexsmobs:warped_muscle'],
            text: [
                `蘑菇君可以通过生育祭坛召唤。而绯红蚊子可以由苍蝇在下界转变而来。`
            ]
        },
        {
