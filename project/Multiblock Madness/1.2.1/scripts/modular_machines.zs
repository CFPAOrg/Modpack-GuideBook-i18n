...
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:assembler"}).addTooltip(format.red("Machine will be removed in upcoming updates, be sure to convert over to the new versions!"));
...
//Fluid Output
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:7>, [[null, <embers:plate_dawnstone>, null],[<embers:plate_dawnstone>, <modularmachinery:blockfluidoutputhatch:6>, <embers:plate_dawnstone>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:6>, [[null, <embers:plate_dawnstone>, null],[<embers:plate_dawnstone>, <modularmachinery:blockfluidoutputhatch:5>, <embers:plate_dawnstone>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:5>, [[null, <embers:plate_dawnstone>, null],[<embers:plate_dawnstone>, <modularmachinery:blockfluidoutputhatch:4>, <embers:plate_dawnstone>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:4>, [[null, <embers:plate_dawnstone>, null],[<embers:plate_dawnstone>, <modularmachinery:blockfluidoutputhatch:3>, <embers:plate_dawnstone>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:3>, [[null, <embers:plate_dawnstone>, null],[<embers:plate_dawnstone>, <modularmachinery:blockfluidoutputhatch:2>, <embers:plate_dawnstone>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:2>, [[null, <thermalfoundation:material:355>, null],[<thermalfoundation:material:355>, <modularmachinery:blockfluidoutputhatch:1>, <thermalfoundation:material:355>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:1>, [[null, <thermalfoundation:material:355>, null],[<thermalfoundation:material:355>, <modularmachinery:blockfluidoutputhatch>, <thermalfoundation:material:355>], [null, <minecraft:bucket>, null]]);
recipes.addShaped(<modularmachinery:blockfluidoutputhatch>, [[null, <thermalfoundation:material:355>, null],[<thermalfoundation:material:355>, <modularmachinery:blockcasing>, <thermalfoundation:material:355>], [null, <minecraft:bucket>, null]]);
...
<iceandfire:dragonsteel_ice_block>.addTooltip(format.darkPurple("暗影冷凝器流体强化方块"));
<deepmoblearning:infused_ingot_block>.addTooltip(format.darkPurple("暗影冷凝器物品强化方块"));
<environmentaltech:aethium>.addTooltip(format.darkPurple("暗影冷凝器速度强化方块"));
<thaumcraft:metal_void>.addTooltip(format.darkPurple("暗影冷凝器2倍输出强化方块"));
<thaumadditions:mithrillium_block>.addTooltip(format.darkPurple("暗影冷凝器3倍输出强化方块"));
<thaumadditions:adaminite_block>.addTooltip(format.darkPurple("暗影冷凝器4倍输出强化方块"));
<thaumadditions:mithminite_block>.addTooltip(format.darkPurple("暗影冷凝器5倍输出强化方块"));
...
<avaritia:block_resource:2>.addTooltip(format.aqua("天堂锻炉流体强化方块"));
