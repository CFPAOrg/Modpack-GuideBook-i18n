...
<mysticalagradditions:insanium:1>.addTooltip(format.darkPurple("章节1的任务奖励"));
<mysticalagriculture:crafting:17>.addTooltip(format.red("不可制作"));
<mysticalagriculture:crafting:18>.addTooltip(format.red("不可制作"));
<mysticalagriculture:crafting:19>.addTooltip(format.red("不可制作"));
<mysticalagriculture:crafting:20>.addTooltip(format.red("不可制作"));
<mysticalagriculture:crafting:21>.addTooltip(format.red("不可制作"));
