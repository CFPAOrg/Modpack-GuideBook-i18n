...
<tombstone:crafting_ingredient:3>.addTooltip(format.darkRed("不常见的怪物凋落物"));
...
<translocators:translocator_part>.addShiftTooltip((format.yellow("- 荧石可增加传输速度\n"))+(format.red("- 红石可开启红石信号控制输入输出功能\n"))+(format.gray("- 铁可以使它在没有位置放置过滤的物品时发出红石信号\n"))+(format.aqua("- 钻石粒能够使它按照过滤进行细微调整")));
<translocators:translocator_part:1>.addShiftTooltip((format.yellow("- 荧石可增加传输速度\n"))+(format.red("- 红石可开启红石信号控制输入输出功能")));
...
<contenttweaker:purpleprint>.addTooltip(format.lightPurple("不是用来合成的！"));
