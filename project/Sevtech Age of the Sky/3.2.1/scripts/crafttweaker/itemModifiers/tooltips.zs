...
static itemTooltipMap as IFormattedText[][IItemStack] = {
	...
	<twilightforest:raven_feather>: [
		format.green("使用Abyssalcraft的"),
		format.green("仪式召唤一只乌鸦。详细"),
		format.green("内容请查看死灵之书")
	],
	<rustic:apiary>: [
		format.green("将蜜蜂放入后，就会增加半径4"),
		format.green("以内作物的生长速度，"),
		format.green("繁育蜜蜂，生产蜜脾")
	],
	<rustic:bee>: [
		format.green("可以在野外的Rustic蜂巢中找到"),
		format.green("可以放入Rustic蜂房")
	],
	...
	*/
	...
	<geolosys:ore:3> : [
		format.green("生成于"),
		format.green("黑暗之地（Darkland）生态岛")
	],
	...
	<geolosys:ore:4>: [
		format.green("生成于"),
		format.green("白桦林（Birch Forest）和平原（Plains）生态岛")
	],
	...
	<geolosys:ore:5>: [
		format.green("生成于"),
		format.green("黑森林（Roofed Forest）和热带草原（Savannah）生态岛")
	],
	...
	<geolosys:ore_vanilla:0>: [
		format.green("生成于"),
		format.green("黑暗之地（Darklands），森林（Forest）和黑森林（Roofed Forest）生态岛")
	],
	...
	<geolosys:ore:0>: [
		format.green("生成于"),
		format.green("草甸（Meadow），平原（Plains），热带草原（Savannah）和沼泽（Swampland）生态岛")
	],
	...
	<astralsorcery:blockcustomore>: [
		format.green("生成于"),
		format.green("冷针叶林（Cold Taiga）和积雪的针叶林（Snowy Coniferous Forest）生态岛")
	],
	...
	<geolosys:ore_vanilla:3>: [
		format.green("生成于"),
		format.green("绿色沼泽（Green Swamp），沼泽（Swampland），温带雨林（Temperate Rainforest）"),
		format.green("和蘑菇岛（Mushroom）生态岛")
	],
	...
	<geolosys:ore_vanilla:2>: [
		format.green("生成于"),
		format.green("恶地（Badlands）和平顶山（Mesa）生态岛")
	],
	...
	<geolosys:ore:8>: [
		format.green("生成于"),
		format.green("岩石高原（Rocky Plateau）生态岛")
	],
	...
	<geolosys:ore:1>  : [
		format.green("生成于"),
		format.green("秋树林（Autumnal Woods）和丛林（Jungle）生态岛")
	],
	...
	<geolosys:ore:6>: [
		format.green("生成于"),
		format.green("黑暗森林（Darklands Forest）和冰川（Glacier）生态岛")
	],
	...
	<geolosys:ore_vanilla:1>: [
		format.green("生成于"),
		format.green("沙漠（Desert）和红木针叶山林（Redwood Taiga Hills）生态岛")
    ],
	<mundaneredstone:redstone_ore>: [
		format.green("生成于"),
		format.green("针叶林（Taiga）生态岛")
	],
	<geolosys:ore_sample_vanilla:1>: [
		format.green("生成于"),
		format.green("沙漠（Desert），红木针叶山林（Redwood Taiga Hills）"),
		format.green("和针叶林（Taiga）生态岛")
	],
    // Bauxite
	<geolosys:ore:7>: [
		format.green("生成于"),
		format.green("小型雨林（Mini Jungle），变异白桦林（Mutated Birch Forest）"),
		format.green("和林地（Woodlansd）生态岛")
	],
	...
	<geolosys:ore_vanilla:4>: [
		format.green("生成于"),
		format.green("门勒格林（meneglin）和茂盛山丘（Lush Hills）生态岛")
	],
	...
	<galacticraftcore:basic_block_core:8>: [
		format.green("生成于"),
		format.green("雨林（Jungle）和变异平原（Mutated Plains）生态岛")
	],
	...
	<geolosys:ore_vanilla:5>: [
		format.green("生成于"),
		format.green("冰刺地（Glacier Spikes）生态岛")
	],
	...
	<contenttweaker:sub_block_holder_0:4>: [
		format.green("生成于"),
		format.green("变异森林（Mutated Forest）和冰原（Ice Flats）生态岛")
	],
	...
	<geolosys:ore_vanilla:6>: [
		format.green("生成于"),
		format.green("峭壁（Extreme Hills）生态岛")
	],
	...
	<geolosys:ore:9>: [
		format.green("生成于"),
		format.green("珊瑚侵染沼泽（Coralium Infested Swamp）生态岛")
	],
	...
	<twilightforest:liveroot>: [
		format.green("生成于暮色森林战利箱"),
		format.green("或通过Bonsai Trees模组获得")
	],
};
