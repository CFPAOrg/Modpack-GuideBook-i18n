...
static itemTooltipMap as IFormattedText[][IItemStack] = {
	...
	<car:key:0>: [
		format.yellow("来自你的车!"),
		format.yellow("在车中按 I 获取"),
		format.yellow("通过用铁合成进行复制")
	],
	...
	<astikorcarts:plowcart:0>: [
		format.yellow("使用“马拉车具”模组"),
		format.yellow("的按键来拴上马")
	],
	...
	<thebetweenlands:volarkite>: [
		...
		<rustic:apiary>: [
		format.red("当在这个中放入蜜蜂"),
		format.red("可以加速4格半径内的作物,"),
		format.red("繁殖蜜蜂,并且生成蜂巢")
	],
	<rustic:bee>: [
		format.red("在世界各地的 Rustic 蜂巢中发现的"),
		format.red("可以放入 Rustic 的养蜂场")
	],
	<twilightforest:liveroot>: [
		format.red("可以在暮色森林的洞穴,地表世界生成,"),
		format.red("战利品箱,"),
		format.red("或者通过盆栽中找到")
	]
};
