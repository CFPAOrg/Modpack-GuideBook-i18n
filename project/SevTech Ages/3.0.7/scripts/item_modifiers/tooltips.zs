...
<ceramics:unfired_clay:4>.addTooltip(format.red("对于磨石配方，你需要将物品在对于的位置上与JEI上显示的位置一致。否则它将无法正常工作。 Otherwise it will not work correctly."));
...
<extraplanets:schematic_tier4>.addTooltip(format.gray("这份工程图可以在金星上的4阶珍宝箱中发现。"));
