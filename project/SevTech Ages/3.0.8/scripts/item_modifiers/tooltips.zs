...
<environmentaltech:lightning_cont_1>.addTooltip(format.aqua("结构大小： 3x7x3"));
<environmentaltech:lightning_cont_2>.addTooltip(format.aqua("结构大小： 3x9x3"));
<environmentaltech:lightning_cont_3>.addTooltip(format.aqua("结构大小： 3x11x3"));
<environmentaltech:lightning_cont_4>.addTooltip(format.aqua("结构大小： 3x13x3"));
<environmentaltech:lightning_cont_5>.addTooltip(format.aqua("结构大小： 3x18x3"));
<environmentaltech:lightning_cont_6>.addTooltip(format.aqua("结构大小： 3x23x3"));

<environmentaltech:nano_cont_personal_1>.addTooltip(format.aqua("结构大小： 5x3x5"));
<environmentaltech:nano_cont_personal_2>.addTooltip(format.aqua("结构大小： 7x4x7"));
<environmentaltech:nano_cont_personal_3>.addTooltip(format.aqua("结构大小： 9x5x9"));
<environmentaltech:nano_cont_personal_4>.addTooltip(format.aqua("结构大小： 11x6x11"));
<environmentaltech:nano_cont_personal_5>.addTooltip(format.aqua("结构大小： 13x7x13"));
<environmentaltech:nano_cont_personal_6>.addTooltip(format.aqua("结构大小： 15x8x15"));
...
<extraplanets:apple_iron>.addTooltip(format.red("吃下这个物品能够"));
...
<thebetweenlands:ring_of_flight>.addTooltip(format.red("或者在Boss的战利品"));
<thebetweenlands:ring_of_flight>.addTooltip(format.red("和稀有掉落几率"));
<thebetweenlands:ring_of_flight>.addTooltip(format.red("来自某些交错次元的敌人"));
...
<totemic:eagle_drops:0>.addTooltip(format.red("没有在世界上找到"));
<totemic:eagle_drops:0>.addTooltip(format.red("鹰是通过图腾仪式产生的"));
<totemic:eagle_drops:1>.addTooltip(format.red("没有在世界上找到"));
...
<ceramics:unfired_clay:4>.addTooltip(format.red("对于磨石配方，你需要将物品在对于的位置上与JEI上显示的位置一致。否则它将无法正常工作。"));

// Death Releated
<death_compass:death_compass>.addTooltip(format.red("站在你的坟墓上 Shift 即可返还物品"));

// Space!
<buildcraftbuilders:quarry>.addTooltip(format.red("这台机器只能在太空中工作！"));

// Creeping Moss
<huntingdim:biome_changer>.addTooltip(format.red("要改变生物群系，用苔藓潜行右键可以将生物群系绑定为你所在的生物群系。"));

// Galacticraft Helpful Hints
<galacticraftcore:schematic>.addTooltip(format.gray("一阶珍宝箱, 在攻略完月球一阶地牢后发现。"));
<galacticraftcore:schematic:1>.addTooltip(format.gray("二阶火箭的工程图可以在一阶珍宝箱中找到，在攻略完月球地牢后找到。"));

<galacticraftplanets:schematic>.addTooltip(format.gray("三阶火箭的工程图可以在二阶珍宝箱中找到，有时可以在完成火星地牢后找到。"));
<galacticraftplanets:schematic:1>.addTooltip(format.gray("运货火箭工程图可以在二阶珍宝箱中找到，在攻略完二阶地牢后发现。"));
<galacticraftplanets:schematic:2>.addTooltip(format.gray("在击败BOSS爬行者之后，在二阶珍宝箱中找到。"));

<extraplanets:schematic_tier4>.addTooltip(format.gray("这份工程图可以在水星上的4阶珍宝箱中发现。"));
<extraplanets:schematic_tier5>.addTooltip(format.gray("这份工程图可以在木星上的5阶珍宝箱中发现。"));
<extraplanets:schematic_tier6>.addTooltip(format.gray("这份工程图可以在土星上的6阶珍宝箱中发现。"));
<extraplanets:schematic_tier7>.addTooltip(format.gray("这份工程图可以在天王星上的7阶珍宝箱中发现。"));
<extraplanets:schematic_tier8>.addTooltip(format.gray("这份工程图可以在海王星上的8阶珍宝箱中发现。"));
<extraplanets:schematic_tier9>.addTooltip(format.gray("这份工程图可以在冥王星上的9阶珍宝箱中发现。"));
<extraplanets:schematic_tier10>.addTooltip(format.gray("这份工程图可以在阋神星上的10阶珍宝箱中发现。"));

<extraplanets:schematic_mars_rover>.addTooltip(format.gray("这份工程图可以在珍宝箱中发现。"));
<extraplanets:schematic_venus_rover>.addTooltip(format.gray("这份工程图可以在金星上的4阶珍宝箱中发现。"));

<betterwithmods:hibachi>.addTooltip(format.red("需要红石信号才能点火"));

<extraplanets:tier1_space_suit_helmet:*>.addTooltip(format.red("只有当安装模块后才开始消耗能量"));
<extraplanets:tier1_space_suit_helmet:*>.addTooltip(format.red("只能使用储能模块充能"));
<extraplanets:tier1_space_suit_chest:*>.addTooltip(format.red("只有当安装模块后才开始消耗能量"));
<extraplanets:tier1_space_suit_chest:*>.addTooltip(format.red("只能使用储能模块充能"));
<extraplanets:tier1_space_suit_legings:*>.addTooltip(format.red("只有当安装模块后才开始消耗能量"));
<extraplanets:tier1_space_suit_legings:*>.addTooltip(format.red("只能使用储能模块充能"));
<extraplanets:tier1_space_suit_boots:*>.addTooltip(format.red("只有当安装模块后才开始消耗能量"));
<extraplanets:tier1_space_suit_boots:*>.addTooltip(format.red("只能使用储能模块充能"));