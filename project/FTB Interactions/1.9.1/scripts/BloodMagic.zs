...
val chemReactor = mods.gregtech.recipe.RecipeMap.getByName("chemical_reactor");
	...
	<bloodmagic:sanguine_book>.addTooltip(format.darkRed("请使用Animus的祭坛推测器。"));
...
<appliedenergistics2:smooth_sky_stone_block>.addTooltip(format.darkRed("用作三级血魔法祭坛柱顶。"));
<ore:blockTitanium>.firstItem.addTooltip(format.darkRed("用作四级血魔法祭坛柱顶。"));
